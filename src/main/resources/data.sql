...
INSERT INTO actions(id, action_cost, action_name) VALUES (101, 45.00, 'Check-up'), (102, 50.00, 'Change tires'), (103, 300.00, 'Change brakes'),
                                                         (104, 125.00, 'Change oil'), (105, 100.00, 'Change battery');

INSERT INTO parts(id, part_name, unit_price) VALUES (701, 'Summer tires', 75.00), (702, 'Winter tires', 75.00), (703, 'Brakes', 50.00),
                                                    (704, 'Battery', 100.00), (705, 'Wheelnuts', 2.50), (706, 'Screws', 1.00);
...
INSERT INTO invoices(id, cost_after_tax, cost_before_tax, paid, customer_id) VALUES (501, 54.45, 45.00, true, 301);

INSERT INTO logs(id, log_status, total_cost, total_parts_cost, action_id, car_id, invoice_id) VALUES (601, 4, 45.00, 00.00, 101, 201, 501),
                                                                                                     (602, 3, 45.00, 00.00, 101, 201, null),
                                                                                                     (603, 3, 200.00, 100.00, 105, 201, null);

INSERT INTO logs_parts(log_id, part_id) VALUES (603, 704);
